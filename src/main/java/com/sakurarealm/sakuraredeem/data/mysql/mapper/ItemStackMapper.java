...
public interface ItemStackMapper {
    ...
    String INSERT_QUERY =
            "INSERT INTO sd_items (package_name, serialized_item)" +
                    "VALUES (#{package_name}, " +
                    "#{serialized_item, typeHandler=com.sakurarealm.sakuraredeem.data.mysql.handler.ItemStackTypeHandler})";
    ...
    @Insert(INSERT_QUERY)
    void insertItemStack(@Param("package_name") String package_name, @Param("serialized_item") ItemStack itemStack);
